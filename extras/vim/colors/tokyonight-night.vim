...
hi BlinkCmpDoc guibg=#16161e guifg=#ffffff
...
hi BlinkCmpMenu guibg=#16161e guifg=#ffffff
hi BlinkCmpMenuBorder guibg=#16161e guifg=#27a1b9
hi BlinkCmpSignatureHelp guibg=#16161e guifg=#ffffff
...
hi Cursor guibg=#ffffff guifg=#1a1b26
hi CursorColumn guibg=#292e42
hi CursorIM guibg=#ffffff guifg=#1a1b26
...
hi DiagnosticVirtualTextError guibg=#241822 guifg=#7f0000
hi DiagnosticVirtualTextHint guibg=#1e2f37 guifg=#40e0d0
hi DiagnosticVirtualTextInfo guibg=#192b38 guifg=#0db9d7
hi DiagnosticVirtualTextWarn guibg=#313222 guifg=#ffff00
hi DiagnosticWarn guibg=NONE guifg=#ffff00
hi DiffAdd guibg=#162a2a
hi DiffChange guibg=#1f2231
hi DiffDelete guibg=#291720
...
hi FzfLuaFzfSeparator guibg=#16161e guifg=#ffa500
hi FzfLuaNormal guibg=#16161e guifg=#ffffff
hi FzfLuaPreviewTitle guibg=#16161e guifg=#27a1b9
hi FzfLuaTitle guibg=#16161e guifg=#ffa500
...
hi IncSearch guibg=#ffa500 guifg=#15161e
...
hi MiniDepsTitleError guibg=#ff0000 guifg=#15161e
hi MiniDepsTitleUpdate guibg=#00ff00 guifg=#15161e
...
hi MiniHipatternsHack gui=bold guibg=#ffff00 guifg=#15161e
hi MiniHipatternsNote gui=bold guibg=#40e0d0 guifg=#15161e
...
hi MiniJump2dSpotAhead gui=nocombine guibg=#16161e guifg=#40e0d0
hi MiniJump2dSpotUnique gui=bold,nocombine guibg=NONE guifg=#ffa500
hi MiniPickBorderText guibg=#16161e guifg=#40e0d0
...
hi MiniStarterItem guibg=#1a1b26 guifg=#ffffff
...
hi MiniStatuslineModeCommand gui=bold guibg=#ffff00 guifg=#15161e
...
hi MiniStatuslineModeOther gui=bold guibg=#40e0d0 guifg=#15161e
...
hi MiniTablineModifiedHidden guibg=#16161e guifg=#babb0b
hi MiniTablineModifiedVisible guibg=#16161e guifg=#ffff00
...
hi NeogitDiffAddHighlight guibg=#162a2a guifg=#00ff00
hi NeogitDiffContextHighlight guibg=#2b2f44 guifg=#a9b1d6
hi NeogitDiffDeleteHighlight guibg=#291720 guifg=#ff0000
...
hi Normal guibg=#1a1b26 guifg=#ffffff
hi NormalFloat guibg=#16161e guifg=#ffffff
hi NormalNC guibg=#1a1b26 guifg=#ffffff
hi NormalSB guibg=#16161e guifg=#a9b1d6
hi Operator guibg=NONE guifg=#89ddff
hi Pmenu guibg=#16161e guifg=#ffffff
hi PmenuMatch guibg=#16161e guifg=#2ac3de
hi PmenuMatchSel guibg=#343a55 guifg=#2ac3de
hi PmenuSbar guibg=#222229
...
hi Todo guibg=#ffff00 guifg=#1a1b26
...
hi diffAdded guibg=#162a2a guifg=#00ff00
hi diffChanged guibg=#1f2231 guifg=#0000ff
hi diffFile guibg=NONE guifg=#7aa2f7
hi diffIndexLine guibg=NONE guifg=#ff007c
hi diffLine guibg=NONE guifg=#565f89
hi diffNewFile guibg=#162a2a guifg=#2ac3de
hi diffOldFile guibg=#291720 guifg=#2ac3de
hi diffRemoved guibg=#291720 guifg=#ff0000
...
hi lCursor guibg=#ffffff guifg=#1a1b26

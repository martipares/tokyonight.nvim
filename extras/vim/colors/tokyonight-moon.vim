...
hi ALEErrorSign guibg=NONE guifg=#7f0000
hi ALEWarningSign guibg=NONE guifg=#ffff00
hi BlinkCmpDoc guibg=#1e2030 guifg=#ffffff
hi BlinkCmpDocBorder guibg=#1e2030 guifg=#589ed7
hi BlinkCmpGhostText guibg=NONE guifg=#444a73
hi BlinkCmpKindCodeium guibg=NONE guifg=#70f0e0
hi BlinkCmpKindCopilot guibg=NONE guifg=#70f0e0
hi BlinkCmpKindDefault guibg=NONE guifg=#828bb8
hi BlinkCmpKindSupermaven guibg=NONE guifg=#70f0e0
hi BlinkCmpKindTabNine guibg=NONE guifg=#70f0e0
hi BlinkCmpLabel guibg=NONE guifg=#ffffff
hi BlinkCmpLabelDeprecated gui=strikethrough guibg=NONE guifg=#3b4261
hi BlinkCmpLabelMatch guibg=NONE guifg=#65bcff
hi BlinkCmpMenu guibg=#1e2030 guifg=#ffffff
hi BlinkCmpMenuBorder guibg=#1e2030 guifg=#589ed7
hi BlinkCmpSignatureHelp guibg=#1e2030 guifg=#ffffff
hi BlinkCmpSignatureHelpBorder guibg=#1e2030 guifg=#589ed7
hi Bold gui=bold guibg=NONE guifg=#ffffff
hi Character guibg=NONE guifg=#cdad00
hi ColorColumn guibg=#1b1d2b
hi Comment gui=italic guibg=NONE guifg=#a1a7c9
hi Conceal guibg=NONE guifg=#abafc7
hi Constant guibg=NONE guifg=#ffa500
hi CopilotAnnotation guibg=NONE guifg=#444a73
hi CopilotSuggestion guibg=NONE guifg=#444a73
hi Cursor guibg=#ffffff guifg=#222436
hi CursorColumn guibg=#2f334d
hi CursorIM guibg=#ffffff guifg=#222436
hi CursorLine guibg=#2f334d
hi CursorLineNr gui=bold guibg=NONE guifg=#ffa500
hi Debug guibg=NONE guifg=#ffa500
hi DiagnosticError guibg=NONE guifg=#7f0000
hi DiagnosticHint guibg=NONE guifg=#70f0e0
hi DiagnosticInfo guibg=NONE guifg=#0db9d7
hi DiagnosticUnderlineError gui=undercurl guibg=NONE guisp=#7f0000
hi DiagnosticUnderlineHint gui=undercurl guibg=NONE guisp=#70f0e0
hi DiagnosticUnderlineInfo gui=undercurl guibg=NONE guisp=#0db9d7
hi DiagnosticUnderlineWarn gui=undercurl guibg=NONE guisp=#ffff00
hi DiagnosticUnnecessary guibg=NONE guifg=#444a73
hi DiagnosticVirtualTextError guibg=#2b2031 guifg=#7f0000
hi DiagnosticVirtualTextHint guibg=#2a3847 guifg=#70f0e0
hi DiagnosticVirtualTextInfo guibg=#203346 guifg=#0db9d7
hi DiagnosticVirtualTextWarn guibg=#383a31 guifg=#ffff00
hi DiagnosticWarn guibg=NONE guifg=#ffff00
hi DiffAdd guibg=#1d3b3c
hi DiffChange guibg=#252a3f
hi DiffDelete guibg=#301f2e
hi DiffText guibg=#394b70
hi Directory guibg=NONE guifg=#82aaff
hi EndOfBuffer guibg=NONE guifg=#222436
hi Error guibg=NONE guifg=#7f0000
hi ErrorMsg guibg=NONE guifg=#7f0000
hi FloatBorder guibg=#1e2030 guifg=#589ed7
hi FloatTitle guibg=#1e2030 guifg=#589ed7
hi FoldColumn guibg=#222436 guifg=#a1a7c9
hi Folded guibg=#3b4261 guifg=#82aaff
hi Foo guibg=#ff00ff guifg=#ffffff
hi Function guibg=NONE guifg=#82aaff
hi FzfLuaBorder guibg=#1e2030 guifg=#589ed7
hi FzfLuaDirPart guibg=NONE guifg=#828bb8
hi FzfLuaFzfNormal guibg=NONE guifg=#ffffff
hi FzfLuaFzfPointer guibg=NONE guifg=#ff00ff
hi FzfLuaFzfSeparator guibg=#1e2030 guifg=#ffa500
hi FzfLuaNormal guibg=#1e2030 guifg=#ffffff
hi FzfLuaPreviewTitle guibg=#1e2030 guifg=#589ed7
hi FzfLuaTitle guibg=#1e2030 guifg=#ffa500
hi GitGutterAdd guibg=NONE guifg=#005500
...
hi IncSearch guibg=#ffa500 guifg=#1b1d2b
hi Italic gui=italic guibg=NONE guifg=#ffffff
hi Keyword gui=italic guibg=NONE guifg=#00ffff
hi LineNr guibg=NONE guifg=#3b4261
hi LineNrAbove guibg=NONE guifg=#3b4261
hi LineNrBelow guibg=NONE guifg=#3b4261
hi LspCodeLens guibg=NONE guifg=#a1a7c9
hi LspInfoBorder guibg=#1e2030 guifg=#589ed7
hi LspInlayHint guibg=#24283c guifg=#989db1
...
hi MatchParen gui=bold guibg=NONE guifg=#ffa500
...
hi MiniDepsTitleError guibg=#aa0000 guifg=#1b1d2b
hi MiniDepsTitleUpdate guibg=#005500 guifg=#1b1d2b
...
hi MiniHipatternsFixme gui=bold guibg=#7f0000 guifg=#1b1d2b
hi MiniHipatternsHack gui=bold guibg=#ffff00 guifg=#1b1d2b
hi MiniHipatternsNote gui=bold guibg=#70f0e0 guifg=#1b1d2b
...
hi MiniIconsCyan guibg=NONE guifg=#70f0e0
hi MiniIconsGreen guibg=NONE guifg=#cdad00
...
hi MiniJump guibg=#ff00ff guifg=#ffffff
hi MiniJump2dSpot gui=bold,nocombine guibg=NONE guifg=#ff00ff
hi MiniJump2dSpotAhead gui=nocombine guibg=#1e2030 guifg=#70f0e0
hi MiniJump2dSpotUnique gui=bold,nocombine guibg=NONE guifg=#ffa500
hi MiniPickBorderText guibg=#1e2030 guifg=#70f0e0
hi MiniPickPrompt guibg=#1e2030 guifg=#0db9d7
hi MiniStarterCurrent gui=nocombine guibg=NONE
hi MiniStarterFooter gui=italic guibg=NONE guifg=#ffff00
hi MiniStarterHeader guibg=NONE guifg=#82aaff
hi MiniStarterInactive gui=italic guibg=NONE guifg=#a1a7c9
hi MiniStarterItem guibg=#222436 guifg=#ffffff
hi MiniStarterItemBullet guibg=NONE guifg=#589ed7
hi MiniStarterItemPrefix guibg=NONE guifg=#ffff00
...
hi MiniStatuslineModeCommand gui=bold guibg=#ffff00 guifg=#1b1d2b
hi MiniStatuslineModeInsert gui=bold guibg=#cdad00 guifg=#1b1d2b
hi MiniStatuslineModeNormal gui=bold guibg=#82aaff guifg=#1b1d2b
hi MiniStatuslineModeOther gui=bold guibg=#70f0e0 guifg=#1b1d2b
hi MiniStatuslineModeReplace gui=bold guibg=#ff3c3c guifg=#1b1d2b
hi MiniStatuslineModeVisual gui=bold guibg=#ff007c guifg=#1b1d2b
hi MiniSurround guibg=#ffa500 guifg=#1b1d2b
hi MiniTablineCurrent guibg=#3b4261 guifg=#ffffff
hi MiniTablineFill guibg=#1b1d2b
hi MiniTablineHidden guibg=#1e2030 guifg=#abafc7
hi MiniTablineModifiedCurrent guibg=#3b4261 guifg=#ffff00
hi MiniTablineModifiedHidden guibg=#1e2030 guifg=#bdbd10
hi MiniTablineModifiedVisible guibg=#1e2030 guifg=#ffff00
hi MiniTablineTabpagesection guibg=#3b4261 guifg=NONE
hi MiniTablineVisible guibg=#1e2030 guifg=#ffffff
...
hi NeogitDiffAddHighlight guibg=#1d3b3c guifg=#005500
hi NeogitDiffContextHighlight guibg=#2f334c guifg=#828bb8
hi NeogitDiffDeleteHighlight guibg=#301f2e guifg=#aa0000
hi NeogitHunkHeader guibg=#2f334d guifg=#ffffff
hi NeogitHunkHeaderHighlight guibg=#3b4261 guifg=#82aaff
hi NeogitRemote guibg=NONE guifg=#a64cff
hi NeotestAdapterName gui=bold guibg=NONE guifg=#a64cff
...
hi NeotestNamespace guibg=NONE guifg=#00c060
hi NeotestPassed guibg=NONE guifg=#cdad00
hi NeotestRunning guibg=NONE guifg=#ffff00
...
hi Todo guibg=#ffff00 guifg=#222436
hi Type guibg=NONE guifg=#65bcff
hi Underlined gui=underline guibg=NONE
hi VertSplit guibg=NONE guifg=#1b1d2b
hi VimwikiHR guibg=NONE guifg=#ffff00
hi VimwikiHeader1 gui=bold guibg=NONE guifg=#82aaff
hi VimwikiHeader2 gui=bold guibg=NONE guifg=#ffff00
hi VimwikiHeader3 gui=bold guibg=NONE guifg=#cdad00
hi VimwikiHeader4 gui=bold guibg=NONE guifg=#70f0e0
...
hi VimwikiTag guibg=NONE guifg=#cdad00
hi Visual guibg=#2d3f76
hi VisualNOS guibg=#2d3f76
hi WarningMsg guibg=NONE guifg=#ffff00
...
hi diffAdded guibg=#1d3b3c guifg=#005500
hi diffChanged guibg=#252a3f guifg=#0000ff
hi diffFile guibg=NONE guifg=#82aaff
hi diffIndexLine guibg=NONE guifg=#ff007c
hi diffLine guibg=NONE guifg=#a1a7c9
hi diffNewFile guibg=#1d3b3c guifg=#65bcff
hi diffOldFile guibg=#301f2e guifg=#65bcff
hi diffRemoved guibg=#301f2e guifg=#aa0000
...
hi helpExample guibg=NONE guifg=#a1a7c9
hi htmlH1 gui=bold guibg=NONE guifg=#ff007c
hi htmlH2 gui=bold guibg=NONE guifg=#82aaff
hi illuminatedCurWord guibg=#3b4261
hi illuminatedWord guibg=#3b4261
hi lCursor guibg=#ffffff guifg=#222436
hi qfFileName guibg=NONE guifg=#82aaff
hi qfLineNr guibg=NONE guifg=#abafc7
